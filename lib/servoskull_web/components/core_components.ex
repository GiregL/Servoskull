defmodule ServoskullWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ServoskullWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ServoskullWeb.Gettext, "errors", msg, opts)
    # end
